    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='club.status')),
            ],
            options={
                'ordering': ('username',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ManyToManyField(related_name='violets', to=settings.AUTH_USER_MODEL)),
                ('variety', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='violets', to='club.variety')),
            ],
            options={
                'ordering': ('sort',),
            },
